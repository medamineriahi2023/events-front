...
export const appRoutes: Route[] = [
    ...
    // Admin routes
    {
        ...
        children: [
            ...
            {path: 'events', loadChildren: () => import('app/modules/participant/events/events.module').then(m => m.EventsModule)},
            {path: 'admin-events', loadChildren: () => import('app/modules/admin/events/events.module').then(m => m.EventsModule)},
