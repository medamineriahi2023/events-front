...
export class AddEventComponent {
  ...
  public types = Object.keys(Type).filter(value => typeof value === 'string');
  public visibilities = Object.keys(Visibility).filter(value => typeof value === 'string');
  
  constructor(private fb: FormBuilder, private eventsService: EventsService, private messageService: MessageService, private confirmationService: ConfirmationService) {
